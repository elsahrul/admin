...
<div class="container-fluid" id="container-wrapper">
    ...
    <div class="row mb-3">
        <?php foreach ($data_kepala_sekolah as $d) : ?>
        ...
        <?php foreach ($data_wakil_kepala_sekolah as $wk) : ?>
            <div class="col-xl-4 col-md-6 mb-4">
                <div class="card h-100">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1"><?= $wk['penempatan_sebagai'] ?></div>
                                <div class="h6 mb-0 font-weight-bold text-gray-800" style="font-size: 12px;"> <?= $wk['nama'] ?>
                                    <p><?= $wk['status_nomor_induk'] ?> : <?= $wk['nomor_induk'] ?></p>
                                </div>
                            </div>
                            <div class="col-auto">
                                <img class="img-profile " src="<?= base_url(); ?>assets/img/<?= $wk['gambar'] ?>" width="50" height="60">
                            </div>
                        </div>
                    </div>
                </div>
